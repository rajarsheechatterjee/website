      ...
      <div className="space-y-12">
        <div>
          <div className="flex items-start gap-3 mb-6">
            ...
            <div>
              <h2 className="text-lg font-medium">Harness</h2>
          ...
          <div className="space-y-8 relative pl-4">
            <div className="relative pl-8 border-l border-neutral-200 dark:border-neutral-800">
              <div className="absolute w-3 h-3 bg-neutral-900 dark:bg-neutral-100 rounded-full left-0 top-0 -translate-x-1/2"></div>
            ...
            <div className="relative pl-8 border-l border-neutral-200 dark:border-neutral-800">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-neutral-600 dark:text-neutral-400">
                  May 2024 - Present · 1 yr 8 mos · Bengaluru, Karnataka, India
                </p>
              </div>
            </div>
            ...
            <div className="relative pl-8 border-l border-neutral-200 dark:border-neutral-800">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-neutral-600 dark:text-neutral-400">
                  Jul 2022 - May 2024 · 1 yr 11 mos · Bengaluru, Karnataka,
                  India
                </p>
              </div>
            </div>
            ...
            <div className="relative pl-8 border-l border-neutral-200 dark:border-neutral-800">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-neutral-600 dark:text-neutral-400">
                  Jan 2022 - Jul 2022 · 7 mos · Bengaluru, Karnataka, India
                </p>
              </div>
            </div>
          </div>
